  ...
  return (<>
    ...
    <div className={s.sidebar}>
      ...
      <div className={s.eleContainer} >
        ...
        {/* <Link to='/online-admin'><div className={s.elements}><TbPointFilled style={{fontSize:"15px"}}/>&nbsp;Online Courses</div></Link> */}
        ...
        {/* <Link to='/syllabus-admin'><div className={s.elements}><TbPointFilled style={{fontSize:"15px"}}/>&nbsp;Syllabus</div></Link> */}
        {/* <Link to='/home-work-admin'><div className={s.elements}><TbPointFilled style={{fontSize:"15px"}}/>&nbsp;Home work</div></Link> */}
        {/* <Link to='/apply-leave-admin'><div className={s.elements}><TbPointFilled style={{fontSize:"15px"}}/>&nbsp;Apply Leave</div></Link> */}
        {/* <Link to='/exams-admin'><div className={s.elements}><TbPointFilled style={{fontSize:"15px"}}/>&nbsp;Exams and Mock tests</div></Link> */}
        {/* <Link to='/results-admin'><div className={s.elements}><TbPointFilled style={{fontSize:"15px"}}/>&nbsp;Results</div></Link> */}
     ...
     <div className={s.pannelName}>Admin-Pannel</div>
